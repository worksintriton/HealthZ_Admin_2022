...
@Component({
  selector: 'app-sp-pet-service-appointment',
  templateUrl: './sp-pet-service-appointment.component.html',
  styleUrls: ['./sp-pet-service-appointment.component.css']
})
export class SpPetServiceAppointmentComponent implements OnInit {
  ...
  goto(page, value){
    ...
    this.router.navigateByUrl('/service_provider/'+page);
  }
